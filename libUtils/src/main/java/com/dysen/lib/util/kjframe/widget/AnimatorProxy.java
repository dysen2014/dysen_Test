 ...
 */
package com.dysen.lib.util.kjframe.widget;
...
/**
 * SlidingMenu所需工具类,对3.0以前的版本进行转换
 * 
 * @author kymjs (https://github.com/kymjs)
 */
public final class AnimatorProxy extends Animation {
    /** Whether or not the current running platform needs to be proxied. */
    public static final boolean NEEDS_PROXY = SystemTool.getSDKVersion() < Build.VERSION_CODES.HONEYCOMB;
