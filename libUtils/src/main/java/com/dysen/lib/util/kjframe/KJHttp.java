 ...
 */
package com.dysen.lib.util.kjframe;

import com.dysen.lib.util.kjframe.http.Cache;
import com.dysen.lib.util.kjframe.http.CacheDispatcher;
import com.dysen.lib.util.kjframe.http.DownloadController;
import com.dysen.lib.util.kjframe.http.DownloadTaskQueue;
import com.dysen.lib.util.kjframe.http.FileRequest;
import com.dysen.lib.util.kjframe.http.FormRequest;
import com.dysen.lib.util.kjframe.http.HttpCallBack;
import com.dysen.lib.util.kjframe.http.HttpConfig;
import com.dysen.lib.util.kjframe.http.HttpParams;
import com.dysen.lib.util.kjframe.http.JsonRequest;
import com.dysen.lib.util.kjframe.http.NetworkDispatcher;
import com.dysen.lib.util.kjframe.http.Request;
import com.dysen.lib.util.kjframe.utils.KJLoger;
...
public class KJHttp {
    ...
    public Request<byte[]> post(String url, HttpParams params,
        ...
        Request<byte[]> request = new FormRequest(Request.HttpMethod.POST, url, params,
                callback);
        request.setShouldCache(useCache);
        doRequest(request);
        return request;
    ...
    public Request<byte[]> jsonPost(String url, HttpParams params,
                                    boolean useCache, HttpCallBack callback) {
        Request<byte[]> request = new JsonRequest(Request.HttpMethod.POST, url, params,
                callback);
        request.setShouldCache(useCache);
        doRequest(request);
        return request;
    ...
    public Request<byte[]> jsonGet(String url, HttpParams params,
                                   HttpCallBack callback) {
        Request<byte[]> request = new JsonRequest(Request.HttpMethod.GET, url, params,
                callback);
        doRequest(request);
        return request;
    }
