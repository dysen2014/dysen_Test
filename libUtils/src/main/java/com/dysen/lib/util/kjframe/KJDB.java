...
import com.dysen.lib.util.kjframe.database.CursorHelper;
import com.dysen.lib.util.kjframe.database.DaoConfig;
import com.dysen.lib.util.kjframe.database.DbModel;
import com.dysen.lib.util.kjframe.database.OneToManyLazyLoader;
import com.dysen.lib.util.kjframe.database.SqlBuilder;
import com.dysen.lib.util.kjframe.database.SqlInfo;
import com.dysen.lib.util.kjframe.database.utils.KeyValue;
import com.dysen.lib.util.kjframe.database.utils.ManyToOne;
import com.dysen.lib.util.kjframe.database.utils.OneToMany;
import com.dysen.lib.util.kjframe.database.utils.TableInfo;
import com.dysen.lib.util.kjframe.ui.KJActivityStack;
...
public class KJDB {
    ...
    public void save(Object entity) {
        try {
            ...
            str = "数据库异常，请卸载重装";
            System.out.println("数据库异常，请卸载重装");
        }
    }

    public void save2(Object entity) throws  Exception{
